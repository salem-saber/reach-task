...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 background-color: #ffc02d; height: 100%; margin: 0; padding: 0; width: 100%">
<center>
 ...
 100%; background-color: #ffc02d; height: 100%; margin: 0; padding: 0; width:
 100%" width="100%">
        <tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #ffc02d;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                                    ...
                                                    <h2>Your Ad Reminder</h2>

                                                    <h1>Hello : {{$ad->advertiser->name}}</h1>
                                                    <h3>Your Ad Information as following</h3>
                                                    <ul>
                                                        <li>Title : {{$ad->title}}</li>
                                                        <li>Description : {{$ad->description}}</li>
                                                        <li>Type : {{$ad->type}}</li>
                                                        <li>Start Date : {{$ad->start_date}}</li>
                                                        <li>Category : {{$ad->category->title}}</li>
                                                        <li>Tags :
